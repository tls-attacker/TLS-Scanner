...
import de.rub.nds.tlsscanner.clientscanner.guideline.results.CertificateAgilityGuidelineCheckResult;
...
/**
 * Checks if the client support the use of multiple client certificates with their associated
 * private keys to support algorithm and key size agility.
 */
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
public class CertificateAgilityGuidelineCheck extends GuidelineCheck<ClientReport> {
