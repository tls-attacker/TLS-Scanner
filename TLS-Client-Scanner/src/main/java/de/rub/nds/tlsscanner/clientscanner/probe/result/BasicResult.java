...
public class BasicResult extends ProbeResult<ClientReport> {
    ...
    private final List<SignatureAndHashAlgorithm> clientAdvertisedSignatureAndHashAlgorithms;
    ...
    public BasicResult(
        ...
        this.clientAdvertisedSignatureAndHashAlgorithms = clientSupportedSignatureAndHashAlgorithms;
    ...
    protected void mergeData(ClientReport report) {
        report.setClientAdvertisedCipherSuites(clientAdvertisedCipherSuites);
        report.setClientAdvertisedCompressions(clientAdvertisedCompressions);
        report.setClientAdvertisedSignatureAndHashAlgorithms(
