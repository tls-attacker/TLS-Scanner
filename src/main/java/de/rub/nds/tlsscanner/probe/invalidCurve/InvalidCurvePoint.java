...
public enum InvalidCurvePoint {
    ...
    SECP160K1(new BigInteger("496029649466609321660480951323582273959831015173"), new BigInteger("496029649466609321660480951323582273959831015173"), new BigInteger("5"), NamedGroup.SECP160K1),
