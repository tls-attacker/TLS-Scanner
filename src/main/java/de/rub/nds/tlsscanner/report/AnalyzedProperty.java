...
public enum AnalyzedProperty {
    ...
    SUPPORTS_UNCOMPRESSED_POINT(AnalyzedPropertyCategory.BEST_PRACTICES),
    SUPPORTS_ANSIX962_COMPRESSED_PRIME(AnalyzedPropertyCategory.BEST_PRACTICES),
    SUPPORTS_ANSIX962_COMPRESSED_CHAR2(AnalyzedPropertyCategory.BEST_PRACTICES),
    SUPPORTS_UNCOMPRESSED_POINT_TLS13(AnalyzedPropertyCategory.BEST_PRACTICES),
    SUPPORTS_ANSIX962_COMPRESSED_PRIME_TLS13(AnalyzedPropertyCategory.BEST_PRACTICES),
    SUPPORTS_ANSIX962_COMPRESSED_CHAR2_TLS13(AnalyzedPropertyCategory.BEST_PRACTICES),
