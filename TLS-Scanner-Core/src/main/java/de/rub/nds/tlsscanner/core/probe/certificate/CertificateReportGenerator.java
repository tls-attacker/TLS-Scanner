...
import de.rub.nds.tlsscanner.core.probe.certificate.roca.BrokenKey;
...
public class CertificateReportGenerator {
    ...
    private static void setSubject(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {
    ...
    private static void setExtendedKeyUsage(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {
        ...
        report.setExtendedKeyUsageServerAuth(
                extension.hasKeyPurposeId(KeyPurposeId.id_kp_serverAuth));
        report.setExtendedKeyUsagePresent(true);
    }

    private static void setCommonNames(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {
    ...
    private static void setAlternativeNames(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {}
    ...
    private static void setValidTo(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {
    ...
    private static void setPubkey(
        ...
        try {
            ...
            if (x509Cert.getPublicKey() != null) {
                ...
                report.setPublicKey(
                        (PublicKey) CertificateUtils.parseCustomPublicKey(x509Cert.getPublicKey()));
            }
    ...
    private static void setWeakDebianKey(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {}

    private static void setIssuer(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {
    ...
    public static SignatureAndHashAlgorithm getSignatureAndHashAlgorithm(
        ...
        try {
            ...
            if (sigAndHashString != null) {
                ...
                if (algos.length != 2) {
                    LOGGER.warn(
                            "Could not parse "
                                    + sigAndHashString
                                    + " into a reasonable SignatureAndHashAlgorithm");
                    return null;
                }
            ...
            LOGGER.debug(
                    "Could not extract SignatureAndHashAlgorithm from String:" + sigAndHashString,
                    e);
        }
        return null;
    }

    private static void setSignatureAndHashAlgorithm(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {
    ...
    private static void setOcspMustStaple(
            CertificateReport report, org.bouncycastle.asn1.x509.Certificate cert) {
        CertificateInformationExtractor ocspCertInfoExtractor =
                new CertificateInformationExtractor(cert);
        try {
        ...
        if (report.getOcspSupported()) {
            ...
            try {
                ...
                try {
                    ...
                    issuerCert =
                            trustAnchorManager.getTrustAnchorCertificate(
            ...
            try {
                ...
                if (ocspResponse != null) {
                    CertificateStatus certificateStatus =
                            ocspResponse.getCertificateStatusList().get(0);
