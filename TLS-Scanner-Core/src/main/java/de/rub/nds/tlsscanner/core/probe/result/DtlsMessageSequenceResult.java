...
public class DtlsMessageSequenceResult<Report extends TlsScanReport> extends ProbeResult<Report> {
    ...
    public DtlsMessageSequenceResult(
            TestResult acceptsStartedWithInvalidMessageNumber,
            TestResult acceptsSkippedMessageNumbersOnce,
            TestResult acceptsSkippedMessageNumbersMultiple,
    ...
    protected void mergeData(Report report) {
        ...
        report.putResult(
                TlsAnalyzedProperty.ACCEPTS_RANDOM_MESSAGE_SEQUENCES, acceptsRandomMessageNumbers);
