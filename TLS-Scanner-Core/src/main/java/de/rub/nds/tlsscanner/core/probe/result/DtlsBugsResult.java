...
public class DtlsBugsResult<Report extends TlsScanReport> extends ProbeResult<Report> {
    ...
    protected void mergeData(Report report) {
        report.putResult(
                TlsAnalyzedProperty.ACCEPTS_UNENCRYPTED_FINISHED, isAcceptingUnencryptedFinished);
