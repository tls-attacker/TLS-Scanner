...
public class LongPaddingGenerator extends PaddingVectorGenerator {
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        ...
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[DEFAULT_CIPHERTEXT_LENGTH
                                                                                        - macSize
        ...
        List<PaddingVector> createClassicModifiedPadding(CipherSuite suite, ProtocolVersion version) {
                ...
                List<PaddingVector> vectorList = createClassicModifiedPaddingWithValidMAC(applicationLength,
                                paddingValue);
                vectorList.addAll(
        ...
        private List<PaddingVector> createClassicModifiedPaddingWithValidMAC(
                ...
                for (int i = 0; i < paddingValue; i++) {
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        "InvPadValMac-[" + i + "]x80-" + applicationLength + "-"
                                                                        + paddingValue,
                                                        "InvPadValMacStart" + i,
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[applicationLength]),
                                                        null,
                                                        new ByteArrayExplicitValueModification(padding)));
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        "InvPadValMac-[" + i + "]x08-" + applicationLength + "-"
                                                                        + paddingValue,
                                                        "InvPadValMacMid" + i,
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[applicationLength]),
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        "InvPadValMac-[" + i + "]x01-" + applicationLength + "-"
                                                                        + paddingValue,
                                                        "InvPadValMacEnd" + i,
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[applicationLength]),
                ...
                for (int i = 0; i < DEFAULT_CIPHERTEXT_LENGTH - applicationLength - paddingValue - 1; i++) {
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        ...
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[applicationLength]),
                                                        new ByteArrayXorModification(new byte[] { (byte) 0b10000000 },
                                                                        i),
                                                        new ByteArrayExplicitValueModification(padding)));
                }
                for (int i = 0; i < paddingValue; i++) {
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        "InvPadInvMac-[" + i + "]x80-" + applicationLength + "-"
                                                                        + paddingValue,
                                                        "InvPadInvMacStart" + i,
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[applicationLength]),
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        "InvPadInvMac-[" + i + "]x08-" + applicationLength + "-"
                                                                        + paddingValue,
                                                        "InvPadInvMacMid" + i,
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[applicationLength]),
                        ...
                        vectorList.add(
                                        new TripleVector(
                                                        "InvPadInvMac-[" + i + "]x01-" + applicationLength + "-"
                                                                        + paddingValue,
                                                        "InvPadInvMacEnd" + i,
                                                        new ByteArrayExplicitValueModification(
                                                                        new byte[applicationLength]),
