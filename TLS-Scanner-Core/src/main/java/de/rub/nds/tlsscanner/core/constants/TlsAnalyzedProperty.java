...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    LIST_SUPPORTED_TOKENBINDINGVERSIONS(TlsAnalyzedPropertyCategory.EXTENSIONS),
    ...
    LIST_HTTPS_HEADER(TlsAnalyzedPropertyCategory.HTTPS_HEADERS),
    ...
    LIST_ENTROPY_REPORTS(TlsAnalyzedPropertyCategory.QUIRKS),
    MAP_RETRANSMISSION_COUNTERS(TlsAnalyzedPropertyCategory.QUIRKS),
    SET_COMMON_DH_VALUES(TlsAnalyzedPropertyCategory.FFDHE),
    LIST_CLIENT_SIMULATION_RESULTS(TlsAnalyzedPropertyCategory.QUIRKS),
    LIST_CCA_TESTRESULTS(TlsAnalyzedPropertyCategory.ATTACKS),
    LIST_GUIDELINE_REPORTS(TlsAnalyzedPropertyCategory.QUIRKS),
    LIST_EXECUTED_PROBE_TYPES(TlsAnalyzedPropertyCategory.QUIRKS),

    // TODO split up client advertised ciphersuites
    LIST_CLIENT_ADVERTISED_CIPHERSUITES(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
    LIST_SMALL_DHE_SUBGROUP_RESULTS(TlsAnalyzedPropertyCategory.FFDHE),
    LIST_COMPOSITE_DHE_MODULUS_RESULTS(TlsAnalyzedPropertyCategory.FFDHE),
