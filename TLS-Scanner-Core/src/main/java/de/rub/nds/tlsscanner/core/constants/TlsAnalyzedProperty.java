...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    ENFORCES_SERVER_CERTIFICATE_MINIMUM_KEY_SIZE_RSA(TlsAnalyzedPropertyCategory.CERTIFICATE),
    ENFORCES_SERVER_CERTIFICATE_MINIMUM_KEY_SIZE_DSS(TlsAnalyzedPropertyCategory.CERTIFICATE),
    ENFORCES_SERVER_CERTIFICATE_MINIMUM_KEY_SIZE_DH(TlsAnalyzedPropertyCategory.CERTIFICATE),
