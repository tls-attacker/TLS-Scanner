...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    /** SessionTicket */
    ISSUES_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    RESUMES_WITH_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    REPEATS_IV_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    UNENCRYPTED_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    DEFAULT_ENCRYPTION_KEY_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    ALLOW_CIPHERSUITE_CHANGE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    NO_MAC_CHECK_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    DEFAULT_HMAC_KEY_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    PADDING_ORACLE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    REPLAY_VULNERABLE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    SUPPORTS_EARLY_DATA_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    REPLAY_VULNERABLE_EARLY_DATA_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
    VERSION_CHANGE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET_EVAL),
