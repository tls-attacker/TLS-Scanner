...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    SUPPORTS_SESSION_IDS(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    ...
    VULNERABLE_TO_RENEGOTIATION_ATTACK_EXTENSION(TlsAnalyzedPropertyCategory.ATTACKS),
    VULNERABLE_TO_RENEGOTIATION_ATTACK_CIPHERSUITE(TlsAnalyzedPropertyCategory.ATTACKS),
