...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    SUPPORTED_PROTOCOLVERSIONS(TlsAnalyzedPropertyCategory.VERSIONS),
    SUPPORTED_EXTENSIONS(TlsAnalyzedPropertyCategory.EXTENSIONS),
    SUPPORTED_NAMEDGROUPS(TlsAnalyzedPropertyCategory.EC),
    SUPPORTED_NAMEDGROUPS_WITNESSES(TlsAnalyzedPropertyCategory.EC),
    SUPPORTED_NAMEDGROUPS_WITNESSES_TLS13(TlsAnalyzedPropertyCategory.EC),
    ...
    TLS13_ECDSA_PKGROUPS(TlsAnalyzedPropertyCategory.CERTIFICATE),
    STATIC_ECDSA_SIGGROUPS(TlsAnalyzedPropertyCategory.CERTIFICATE),
    EPHEMERAL_ECDSA_SIGGROUPS(TlsAnalyzedPropertyCategory.CERTIFICATE),
    TLS13_ECDSA_SIGGROUPS(TlsAnalyzedPropertyCategory.CERTIFICATE),
    ...
    REPORT_ONLY_HPKPPINS(TlsAnalyzedPropertyCategory.HTTPS_HEADERS),
    ...
    CLIENT_ADVERTISED_NAMEDGROUPS(TlsAnalyzedPropertyCategory.EC),
    CLIENT_ADVERTISED_KEYSHARE_NAMEDGROUPS(TlsAnalyzedPropertyCategory.EC),
