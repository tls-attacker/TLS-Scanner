...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    /** SessionTicket */
    ISSUES_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    RESUMES_WITH_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    UNENCRYPTED_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    NO_MAC_CHECK_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    DEFAULT_ENCRYPTION_KEY_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    DEFAULT_HMAC_KEY_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    ALLOW_CIPHERSUITE_CHANGE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    ALLOW_VERSION_CHANGE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    PADDING_ORACLE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    REPLAY_VULNERABLE_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    SUPPORTS_EARLY_DATA_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
    REPLAY_VULNERABLE_EARLY_DATA_TICKET(TlsAnalyzedPropertyCategory.SESSION_TICKET),
