...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    LIST_SUPPORTED_SIGNATUREANDHASH_ALGORITHMS_CERT(TlsAnalyzedPropertyCategory.LIST),
    LIST_SUPPORTED_SIGNATUREANDHASH_ALGORITHMS_SKE(TlsAnalyzedPropertyCategory.LIST),
    LIST_SUPPORTED_SIGNATUREANDHASH_ALGORITHMS_TLS13(TlsAnalyzedPropertyCategory.LIST),
    LIST_SUPPORTED_TOKENBINDINGVERSION(TlsAnalyzedPropertyCategory.LIST),
    LIST_SUPPORTED_TOKENBINDING_KEYPARAMETERS(TlsAnalyzedPropertyCategory.LIST),
    LIST_SUPPORTED_ALPNS(TlsAnalyzedPropertyCategory.LIST),
    LIST_SUPPORTED_COMPRESSION_METHODS(TlsAnalyzedPropertyCategory.LIST),
    ...
    LIST_ENTROPY_REPORT(TlsAnalyzedPropertyCategory.LIST),
    MAP_RETRANSMISSION_COUNTERS(TlsAnalyzedPropertyCategory.MAP),
    SET_USED_COMMON_DHVALUE(TlsAnalyzedPropertyCategory.SET),
    LIST_SIMULATED_CLIENT(TlsAnalyzedPropertyCategory.LIST),
    LIST_CCA_TESTRESULT(TlsAnalyzedPropertyCategory.LIST),
