...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    LIST_SUPPORTED_NAMEDGROUPS(TlsAnalyzedPropertyCategory.EC),
    MAP_SUPPORTED_NAMEDGROUPS_WITNESSES(TlsAnalyzedPropertyCategory.EC),
    MAP_SUPPORTED_NAMEDGROUPS_WITNESSES_TLS13(TlsAnalyzedPropertyCategory.EC),
    LIST_SUPPORTED_TLS13_GROUPS(TlsAnalyzedPropertyCategory.EC),
    LIST_SUPPORTED_SIGNATURE_AND_HASH_ALGORITHMS_CERT(TlsAnalyzedPropertyCategory.CERTIFICATE),
    LIST_SUPPORTED_SIGNATURE_AND_HASH_ALGORITHMS_SKE(TlsAnalyzedPropertyCategory.CERTIFICATE),
    LIST_SUPPORTED_SIGNATURE_AND_HASH_ALGORITHMS_TLS13(TlsAnalyzedPropertyCategory.CERTIFICATE),
    LIST_SUPPORTED_TOKENBINDINGVERSION(TlsAnalyzedPropertyCategory.EXTENSIONS),
    LIST_SUPPORTED_TOKENBINDING_KEYPARAMETERS(TlsAnalyzedPropertyCategory.EXTENSIONS),
    ...
    LIST_CERTIFICATE_CHAIN(TlsAnalyzedPropertyCategory.CERTIFICATE),
    ...
    LIST_EPHEMERAL_ECDSA_SIGGROUPS(TlsAnalyzedPropertyCategory.CERTIFICATE),
    LIST_TLS13_ECDSA_SIGGROUPS(TlsAnalyzedPropertyCategory.CERTIFICATE),
    LIST_OCSP_RESULTS(TlsAnalyzedPropertyCategory.OCSP),
    LIST_VERSIONSUITE_PAIRS(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
    SET_SUPPORTED_CIPHERSUITES(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
    LIST_HEADER(TlsAnalyzedPropertyCategory.HTTPS_HEADERS),
    LIST_NORMAL_HPKPPINS(TlsAnalyzedPropertyCategory.HTTPS_HEADERS),
    LIST_REPORT_ONLY_HPKPPINS(TlsAnalyzedPropertyCategory.HTTPS_HEADERS),
    MAP_EXTRACTED_VALUECONTAINTER(TlsAnalyzedPropertyCategory.QUIRKS),
    LIST_ENTROPY_REPORT(TlsAnalyzedPropertyCategory.QUIRKS),
    MAP_RETRANSMISSION_COUNTERS(TlsAnalyzedPropertyCategory.QUIRKS),
    SET_USED_COMMON_DHVALUE(TlsAnalyzedPropertyCategory.FFDHE),
    LIST_SIMULATED_CLIENT(TlsAnalyzedPropertyCategory.QUIRKS),
    LIST_CCA_TESTRESULT(TlsAnalyzedPropertyCategory.ATTACKS),
    LIST_GUIDELINE_REPORTS(TlsAnalyzedPropertyCategory.QUIRKS),
    LIST_PROBETYPES(TlsAnalyzedPropertyCategory.QUIRKS),

    LIST_ADVERTISED_CIPHERSUITES(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
    LIST_SMALL_DHESUBGROUP_RESULTS(TlsAnalyzedPropertyCategory.FFDHE),
    LIST_COMPOSITE_DHEMODULUS_RESULT(TlsAnalyzedPropertyCategory.FFDHE),
    LIST_CLIENT_ADVERTISED_COMPRESSIONS(TlsAnalyzedPropertyCategory.COMPRESSION),
    LIST_CLIENT_ADVERTISED_SIGNATURE_AND_HASH_ALGORITHMS(TlsAnalyzedPropertyCategory.QUIRKS),
    SET_CLIENT_ADVERTISED_EXTENSIONS(TlsAnalyzedPropertyCategory.EXTENSIONS),
    LIST_CLIENT_ADVERTISED_NAMEDGROUPS(TlsAnalyzedPropertyCategory.EC),
    LIST_CLIENT_ADVERTISED_KEYSHARE_NAMEDGROUPS(TlsAnalyzedPropertyCategory.EC),
    LIST_CLIENT_ADVERTISED_POINTFORMATS(TlsAnalyzedPropertyCategory.EC),
