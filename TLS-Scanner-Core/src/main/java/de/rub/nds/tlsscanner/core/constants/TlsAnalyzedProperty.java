...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
	...
	TLS13_ECDSA_SIG_GROUPS(TlsAnalyzedPropertyCategory.CERTIFICATE), OCSP_RESULTS(TlsAnalyzedPropertyCategory.OCSP),
	...
	COMMON_DH_VALUES(TlsAnalyzedPropertyCategory.FFDHE), CLIENT_SIMULATION_RESULTS(TlsAnalyzedPropertyCategory.QUIRKS),
	CCA_TEST_RESULTS(TlsAnalyzedPropertyCategory.ATTACKS), GUIDELINE_REPORTS(TlsAnalyzedPropertyCategory.QUIRKS),
	EXECUTED_PROBE_TYPES(TlsAnalyzedPropertyCategory.QUIRKS),

	// TODO split up client advertised ciphersuites
	CLIENT_ADVERTISED_CIPHERSUITES(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	SMALL_DHE_SUBGROUP_RESULTS(TlsAnalyzedPropertyCategory.FFDHE),
	COMPOSITE_DHE_MODULUS_RESULTS(TlsAnalyzedPropertyCategory.FFDHE),
	CLIENT_ADVERTISED_COMPRESSIONS(TlsAnalyzedPropertyCategory.COMPRESSION),
	CLIENT_ADVERTISED_SIGNATURE_AND_HASH_ALGORITHMS(TlsAnalyzedPropertyCategory.QUIRKS),
	...
	SUPPORTS_TLS_1_1(TlsAnalyzedPropertyCategory.VERSIONS), SUPPORTS_TLS_1_2(TlsAnalyzedPropertyCategory.VERSIONS),
	...
	SUPPORTS_DTLS_1_0(TlsAnalyzedPropertyCategory.VERSIONS), SUPPORTS_DTLS_1_2(TlsAnalyzedPropertyCategory.VERSIONS),
	SUPPORTS_DTLS_1_3(TlsAnalyzedPropertyCategory.VERSIONS), SUPPORTS_PFS(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	...
	SUPPORTS_ANON(TlsAnalyzedPropertyCategory.CIPHER_SUITES), SUPPORTS_DES(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	SUPPORTS_3DES(TlsAnalyzedPropertyCategory.CIPHER_SUITES), SUPPORTS_SEED(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	SUPPORTS_IDEA(TlsAnalyzedPropertyCategory.CIPHER_SUITES), SUPPORTS_RC2(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	...
	SUPPORTS_CBC(TlsAnalyzedPropertyCategory.CIPHER_SUITES), SUPPORTS_AEAD(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	...
	SUPPORTS_CHACHA(TlsAnalyzedPropertyCategory.CIPHER_SUITES), SUPPORTS_RSA(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	SUPPORTS_STATIC_DH(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	SUPPORTS_DHE(TlsAnalyzedPropertyCategory.CIPHER_SUITES), SUPPORTS_ECDHE(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	...
	SUPPORTS_DSS(TlsAnalyzedPropertyCategory.CIPHER_SUITES), SUPPORTS_GOST(TlsAnalyzedPropertyCategory.CIPHER_SUITES),
	...
	SUPPORTS_HTTPS(TlsAnalyzedPropertyCategory.HTTPS_HEADERS), SUPPORTS_HSTS(TlsAnalyzedPropertyCategory.HTTPS_HEADERS),
	...
	GROUPS_DEPEND_ON_CIPHER(TlsAnalyzedPropertyCategory.EC), SUPPORTS_OCSP(TlsAnalyzedPropertyCategory.OCSP),
	PREFERS_PFS(TlsAnalyzedPropertyCategory.BEST_PRACTICES), ENFORCES_PFS(TlsAnalyzedPropertyCategory.BEST_PRACTICES),
	...
	STRICT_SNI(TlsAnalyzedPropertyCategory.SNI), STRICT_ALPN(TlsAnalyzedPropertyCategory.EXTENSIONS),
	...
	VULNERABLE_TO_CRIME(TlsAnalyzedPropertyCategory.ATTACKS), VULNERABLE_TO_BREACH(TlsAnalyzedPropertyCategory.ATTACKS),
	VULNERABLE_TO_LOGJAM(TlsAnalyzedPropertyCategory.ATTACKS), VULNERABLE_TO_FREAK(TlsAnalyzedPropertyCategory.ATTACKS),
	...
	HAS_CERTIFICATE_ISSUES(TlsAnalyzedPropertyCategory.CERTIFICATE), MUST_STAPLE(TlsAnalyzedPropertyCategory.OCSP),
	INCLUDES_CERTIFICATE_STATUS_MESSAGE(TlsAnalyzedPropertyCategory.OCSP),
	STAPLED_RESPONSE_EXPIRED(TlsAnalyzedPropertyCategory.OCSP), SUPPORTS_NONCE(TlsAnalyzedPropertyCategory.OCSP),
	SUPPORTS_STAPLED_NONCE(TlsAnalyzedPropertyCategory.OCSP), SUPPORTS_OCSP_STAPLING(TlsAnalyzedPropertyCategory.OCSP),
	NONCE_MISMATCH(TlsAnalyzedPropertyCategory.OCSP), STAPLING_UNRELIABLE(TlsAnalyzedPropertyCategory.OCSP),
	...
	REUSES_GCM_NONCES(TlsAnalyzedPropertyCategory.FRESHNESS), REQUIRES_SNI(TlsAnalyzedPropertyCategory.SNI),
	HAS_GNU_TLS_MAGIC_BYTES(TlsAnalyzedPropertyCategory.SESSION_TICKET),
	/** CCA Properties */
	SUPPORTS_CCA(TlsAnalyzedPropertyCategory.CERTIFICATE), REQUIRES_CCA(TlsAnalyzedPropertyCategory.CERTIFICATE),
	...
	SUPPORTS_EVEN_MODULUS(TlsAnalyzedPropertyCategory.FFDHE), SUPPORTS_MOD3_MODULUS(TlsAnalyzedPropertyCategory.FFDHE),
	SUPPORTS_MODULUS_ONE(TlsAnalyzedPropertyCategory.FFDHE), SUPPORTS_GENERATOR_ONE(TlsAnalyzedPropertyCategory.FFDHE),
	/** DTLS */
	...
	PROCESSES_RETRANSMISSIONS(TlsAnalyzedPropertyCategory.QUIRKS), CHANGES_PORT(TlsAnalyzedPropertyCategory.QUIRKS),
	...
	ACCEPTS_SERVER_HELLO_RECORD_SEQUENCE_NUMBER_MISMATCH(TlsAnalyzedPropertyCategory.HELLO_VERIFY_REQUEST),
