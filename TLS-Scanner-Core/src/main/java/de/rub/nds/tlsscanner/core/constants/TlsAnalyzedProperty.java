...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    ISSUES_TLS13_SESSION_TICKETS_WITH_HTTPS(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    ...
    /** SessionTicket */
    UNENCRYPTED_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    NO_MAC_CHECK_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    DEFAULT_ENCRYPTION_KEY_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    DEFAULT_HMAC_KEY_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    ALLOW_CIPHERSUITE_CHANGE_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    ALLOW_VERSION_CHANGE_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    PADDING_ORACLE_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
    REUSABLE_TICKET(TlsAnalyzedPropertyCategory.SESSION_RESUMPTION),
