...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    LIST_SUPPORTED_SIGNATUREANDHASH_ALGORITHMS_CERT(TlsAnalyzedPropertyCategory.CERTIFICATE),
    LIST_SUPPORTED_SIGNATUREANDHASH_ALGORITHMS_SKE(TlsAnalyzedPropertyCategory.CERTIFICATE),
    LIST_SUPPORTED_SIGNATUREANDHASH_ALGORITHMS_TLS13(TlsAnalyzedPropertyCategory.CERTIFICATE),
    ...
    LIST_CLIENT_ADVERTISED_SIGNATUREANDHASH_ALGORITHMS(TlsAnalyzedPropertyCategory.QUIRKS),
