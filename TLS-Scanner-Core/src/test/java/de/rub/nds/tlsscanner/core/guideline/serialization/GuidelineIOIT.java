 ...
 */
package de.rub.nds.tlsscanner.core.guideline.serialization;
...
import de.rub.nds.tlsscanner.core.guideline.checks.AnalyzedPropertyGuidelineCheck;
...
public class GuidelineIOIT {
    ...
    public void testDeSerializationSimple(@TempDir File tempDir)
        ...
        this.result = (Guideline) guidelineIO.read(new ByteArrayInputStream(stream.toByteArray()));
        ...
        this.result = (Guideline) guidelineIO.read(tempFile);
