...
public class InvalidCurveResult extends ProbeResult<ServerReport> {
    ...
    public InvalidCurveResult(
            TestResult vulnerableClassic,
            TestResult vulnerableEphemeral,
            TestResult vulnerableTwist,
    ...
    public void mergeData(ServerReport report) {
        ...
        report.putResult(
                TlsAnalyzedProperty.VULNERABLE_TO_INVALID_CURVE_EPHEMERAL, vulnerableEphemeral);
