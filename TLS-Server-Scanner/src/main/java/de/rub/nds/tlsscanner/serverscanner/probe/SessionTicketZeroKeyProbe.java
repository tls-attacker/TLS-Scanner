...
public class SessionTicketZeroKeyProbe extends TlsServerProbe<ConfigSelector, ServerReport> {
	...
	/**
	 * Offset of the length field for the in the encrypted state according to the
	 * ticket struct in rfc5077
	 */
	public static final int SESSION_STATE_LEN_FIELD_OFFSET = 32;

	/**
	 * Length of the length field for the in the encrypted state according to the
	 * ticket struct in rfc5077
	 */
	...
	public SessionTicketZeroKeyProbe(ConfigSelector configSelector, ParallelExecutor parallelExecutor) {
		...
		register(TlsAnalyzedProperty.VULNERABLE_TO_SESSION_TICKET_ZERO_KEY,
	...
	public void executeTest() {
		...
		encryptedSessionState = Arrays.copyOfRange(ticket, SESSION_STATE_OFFSET,
				SESSION_STATE_OFFSET + sessionStateLenInt);
		try {
