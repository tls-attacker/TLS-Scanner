...
public enum DefaultConfigProfile implements ConfigFilterProfile {
    ...
    MODERATELY_REDUCED_NAMED_GROUPS(SLIGHTLY_REDUCED_NAMED_GROUPS.getConfigFilterTypes(),
        ConfigFilterType.NAMEDGROUP_SECT),
    HIGHLY_REDUCED_NAMED_GROUPS(MODERATELY_REDUCED_NAMED_GROUPS.getConfigFilterTypes(),
    ...
    CLEAN_TLS_13(ArrayConverter.concatenate(CLEAN_NAMED_GROUPS_TLS_13.getConfigFilterTypes(),
...
<<<<<<< HEAD
            HIGHLY_REDUCED_CIPHERSUITES, SLIGHTLY_REDUCED_NAMED_GROUPS, MODERATELY_REDUCED_NAMED_GROUPS,
            HIGHLY_REDUCED_NAMED_GROUPS, SLIGHTLY_REDUCED_SIGNATUREALGORITHMS, MODERATELY_REDUCED_SIGNATUREALGORITHMS,
...
>>>>>>> master
    ...
    public static DefaultConfigProfile[] getTls13ConfigProfiles() {
        return new DefaultConfigProfile[] { RICH_TLS_13, SLIGHTLY_REDUCED_NAMED_GROUPS, MODERATELY_REDUCED_NAMED_GROUPS,
            CLEAN_NAMED_GROUPS_TLS_13, CLEAN_SIGNATUREALGORITHMS_TLS_13, CLEAN_TLS_13 };
    }
