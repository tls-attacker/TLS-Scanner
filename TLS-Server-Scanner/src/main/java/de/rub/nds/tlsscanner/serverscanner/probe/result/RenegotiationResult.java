...
public class RenegotiationResult extends ProbeResult<ServerReport> {
    ...
    public RenegotiationResult(
            TestResult secureRenegotiationExtension,
            TestResult secureRenegotiationCipherSuite,
            TestResult insecureRenegotiation,
            TestResult vulnerableRenegotiationAttackExtensionV1,
            TestResult vulnerableRenegotiationAttackExtensionV2,
            TestResult vulnerableRenegotiationAttackCipherSuiteV1,
            TestResult vulnerableRenegotiationAttackCipherSuiteV2,
            TestResult supportsDtlsCookieExchangeInRenegotiation) {
