...
public class DtlsFeaturesProbe extends TlsProbe<ServerScannerConfig, ServerReport> {
    ...
    public DtlsFeaturesProbe(ServerScannerConfig scannerConfig, ParallelExecutor parallelExecutor) {
        ...
        super.register(TlsAnalyzedProperty.SUPPORTS_DTLS_FRAGMENTATION, TlsAnalyzedProperty.SUPPORTS_REORDERING);
    }

    @Override
    public void executeTest() {
        supportsFragmentation = supportsFragmentation();
    ...
    protected void mergeData(ServerReport report) {
        super.put(TlsAnalyzedProperty.SUPPORTS_DTLS_FRAGMENTATION, supportsFragmentation);
