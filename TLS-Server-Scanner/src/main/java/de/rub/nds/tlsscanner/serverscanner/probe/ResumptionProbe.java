...
public class ResumptionProbe extends TlsServerProbe<ConfigSelector, ServerReport> {
    ...
    public void executeTest() {
        ...
        if (configSelector.getScannerConfig().getDtlsDelegate().isDTLS()) {
            ...
            supportsTls13SessionTicket =
                supportsTls13PskDhe = supportsTls13Psk = supportsTls13_0rtt = TestResults.NOT_TESTED_YET;
        } else {
            ...
            supportsTls13SessionTicket = getIssuesSessionTicket();
    ...
    public void adjustConfig(ServerReport report) {
        supportedSuites = ((SetResult<CipherSuite>) report.getSetResult(TlsAnalyzedProperty.SET_SUPPORTED_CIPHERSUITES)).getSet();
