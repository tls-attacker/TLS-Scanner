...
public class TlsScanner {
    ...
    private void fillDefaultProbeLists() {
        addProbeToProbeList.add(new CommonBugProbe(config, parallelExecutor));
        addProbeToProbeList.add(new SniProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CompressionsProbe(config, parallelExecutor));
        addProbeToProbeList.add(new NamedCurvesProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CertificateProbe(config, parallelExecutor));
        addProbeToProbeList.add(new OcspProbe(config, parallelExecutor));
        addProbeToProbeList.add(new ProtocolVersionProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CipherSuiteProbe(config, parallelExecutor));
        addProbeToProbeList.add(new DirectRaccoonProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CipherSuiteOrderProbe(config, parallelExecutor));
        addProbeToProbeList.add(new ExtensionProbe(config, parallelExecutor));
        addProbeToProbeList.add(new TokenbindingProbe(config, parallelExecutor));
        addProbeToProbeList.add(new HttpHeaderProbe(config, parallelExecutor));
        addProbeToProbeList.add(new HttpFalseStartProbe(config, parallelExecutor));
        addProbeToProbeList.add(new ECPointFormatProbe(config, parallelExecutor));
        addProbeToProbeList.add(new ResumptionProbe(config, parallelExecutor));
        addProbeToProbeList.add(new RenegotiationProbe(config, parallelExecutor));
        addProbeToProbeList.add(new SessionTicketZeroKeyProbe(config, parallelExecutor));
        addProbeToProbeList.add(new HeartbleedProbe(config, parallelExecutor));
        addProbeToProbeList.add(new PaddingOracleProbe(config, parallelExecutor));
        addProbeToProbeList.add(new BleichenbacherProbe(config, parallelExecutor));
        addProbeToProbeList.add(new TlsPoodleProbe(config, parallelExecutor));
        addProbeToProbeList.add(new InvalidCurveProbe(config, parallelExecutor));
        addProbeToProbeList.add(new DrownProbe(config, parallelExecutor));
        addProbeToProbeList.add(new EarlyCcsProbe(config, parallelExecutor));
        // addProbeToProbeList.add(new MacProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CcaSupportProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CcaRequiredProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CcaProbe(config, parallelExecutor));
        addProbeToProbeList.add(new EsniProbe(config, parallelExecutor));
        addProbeToProbeList.add(new CertificateTransparencyProbe(config, parallelExecutor));
        addProbeToProbeList.add(new RecordFragmentationProbe(config, parallelExecutor));
        addProbeToProbeList.add(new HelloRetryProbe(config, parallelExecutor));
