...
public enum TicketEncryptionAlgorithm {
    ...
    AES_128_CTR(16, 16, 0, "AES/CTR/NoPadding"),
    AES_256_CTR(32, 16, 0, "AES/CTR/NoPadding"),
    AES_128_CCM(16, 16, 0, "AES/CCM/NoPadding", "AES/CTR/NoPadding"),
    AES_256_CCM(32, 16, 0, "AES/CCM/NoPadding", "AES/CTR/NoPadding"),
    AES_128_GCM(16, 12, 0, "AES/GCM/NoPadding", "AES/CTR/NoPadding"),
    AES_256_GCM(32, 12, 0, "AES/GCM/NoPadding", "AES/CTR/NoPadding"),
    CHACHA20_POLY1305(32, 12, 0, "ChaCha20-Poly1305", "ChaCha20");
    ...
    private TicketEncryptionAlgorithm(int keySize, int ivNonceSize, int blockSize, String javaName,
    ...
    private static Cipher getCipherInstance(TicketEncryptionAlgorithm algo) {
        try {
            ...
            LOGGER.warn("Could not initialize TicketEncryptionAlgorithm for {} (tried java name {})", algo,
                algo.javaNameForDecryption, e);
            return null;
        }
    }
    ...
    /**
     * we decrypt gcm using counter mode, therefore we have to generate correct initial counter value counter_0 =
     * nonce(12 bytes) || 0002
     *
     * @param  nonce
     *               12 byte nonce sent by server
     * @return       counter_0
     */
    ...
    /**
     * the ccm decryption uses ctr mode, therefore we have to generate the correct initial counter value Q=
     * 15-1-nonce_length in our case nonce_length fixed to 12 -> Q=2 counter_0 = Q || nonce(12 bytes) || 001
     *
     * @param  nonce
     * @return
     */
