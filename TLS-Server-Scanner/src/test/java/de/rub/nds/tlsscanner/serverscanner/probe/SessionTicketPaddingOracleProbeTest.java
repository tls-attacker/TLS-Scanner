...
public class SessionTicketPaddingOracleProbeTest {
    ...
    //                 "{prefixSize=%d, contentLength=%d, initialPaddingSize=%d, suffixSize=%d,
    // blockSize=%d, paddingType=%s}",
    //                 prefixSize,
    //                 contentLength,
    //                 initialPaddingSize,
    //                 suffixSize,
    ...
    //         ParallelExecutor.create(1, 0);
    //         this.params = parameters;

    //         List<Record> recordList = new ArrayList<>();
    //         fingerprintAbortConnection =
    //                 new ResponseFingerprint(Arrays.asList(), recordList,
    ...
    //         fingerprintUseTicket =
    //                 new ResponseFingerprint(
    //                         Arrays.asList(new ServerHelloMessage(), new
    ...
    //         // decOffset points to first byte of last block (hence subtract suffix [skip suffix]
    // and
