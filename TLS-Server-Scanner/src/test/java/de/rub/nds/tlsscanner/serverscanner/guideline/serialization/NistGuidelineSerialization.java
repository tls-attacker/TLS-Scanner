...
public class NistGuidelineSerialization {
    ...
    public void serialize() throws JAXBException, IOException {
        ...
        checks.add(new AnalyzedPropertyGuidelineCheck(
            ...
            RequirementLevel.MUST, TlsAnalyzedProperty.SUPPORTS_OCSP, TestResult.TRUE));
        ...
        checks.add(new CertificateSignatureCheck(
            ...
            GuidelineCheckCondition
                .or(Arrays.asList(new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_0, TestResult.TRUE),
                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_1, TestResult.TRUE))),
            false));
        ...
        checks.add(new AnalyzedPropertyGuidelineCheck("Servers shall not be vulnerable to padding oracle.",
            RequirementLevel.MUST, TlsAnalyzedProperty.VULNERABLE_TO_PADDING_ORACLE, TestResult.FALSE));
        checks.add(new AnalyzedPropertyGuidelineCheck(
            "The random number generator should be used to generate the 4-byte timestamp of the server random value.",
            RequirementLevel.SHOULD, TlsAnalyzedProperty.USES_UNIX_TIMESTAMPS_IN_RANDOM, TestResult.FALSE));
        ...
        checks.add(new AnalyzedPropertyGuidelineCheck("The server shall support secure renegotiation Extension.",
            ...
            GuidelineCheckCondition
                .or(Arrays.asList(new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_0, TestResult.TRUE),
                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_1, TestResult.TRUE),
                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_2, TestResult.TRUE))),
            TlsAnalyzedProperty.SUPPORTS_SECURE_RENEGOTIATION_EXTENSION, TestResult.TRUE));
        ...
        checks.add(new AnalyzedPropertyGuidelineCheck("The Extended Master Secret extension shall be supported.",
            ...
            GuidelineCheckCondition
                .or(Arrays.asList(new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_0, TestResult.TRUE),
                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_1, TestResult.TRUE),
                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_2, TestResult.TRUE))),
            TlsAnalyzedProperty.SUPPORTS_EXTENDED_MASTER_SECRET, TestResult.TRUE));
        checks.add(new AnalyzedPropertyGuidelineCheck(
        ...
        checks.add(new AnalyzedPropertyGuidelineCheck(
            ...
            GuidelineCheckCondition.and(Arrays.asList(
                GuidelineCheckCondition.or(
                    Arrays.asList(new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_0, TestResult.TRUE),
                        new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_1, TestResult.TRUE))),
                new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_3, TestResult.FALSE))),
            TlsAnalyzedProperty.SUPPORTS_TLS_FALLBACK_SCSV, TestResult.TRUE));
        checks.add(new NamedGroupsGuidelineCheck(
            ...
            RequirementLevel.MUST,
            GuidelineCheckCondition
                .or(Arrays.asList(new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_ECDHE, TestResult.TRUE),
                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_3, TestResult.TRUE))),
                        ...
                        .and(
                            Arrays.asList(
                                GuidelineCheckCondition.or(Arrays.asList(
                                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_0, TestResult.TRUE),
                                    new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_1, TestResult.TRUE),
            ...
            GuidelineCheckCondition.and(Arrays.asList(
                GuidelineCheckCondition.or(
                    Arrays.asList(new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_0, TestResult.TRUE),
                        new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_1, TestResult.TRUE),
                        new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_2, TestResult.TRUE))),
                new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_OCSP, TestResult.TRUE))),
            TlsAnalyzedProperty.SUPPORTS_CERTIFICATE_STATUS_REQUEST_V2, TestResult.TRUE));
        checks.add(new AnalyzedPropertyGuidelineCheck(
            ...
            GuidelineCheckCondition.and(Arrays.asList(
                GuidelineCheckCondition.or(
                    Arrays.asList(new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_0, TestResult.TRUE),
                        new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_1, TestResult.TRUE),
                        new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_2, TestResult.TRUE))),
                new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_BLOCK_CIPHERS, TestResult.TRUE))),
            TlsAnalyzedProperty.SUPPORTS_ENCRYPT_THEN_MAC, TestResult.TRUE));
            ...
            GuidelineCheckCondition
                .and(
                    Arrays
                        .asList(
                            GuidelineCheckCondition.or(Arrays.asList(
                                new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS13_PSK, TestResult.TRUE),
                                new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS13_PSK_DHE,
                                    TestResult.TRUE))),
                            new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_3, TestResult.TRUE))),
            TlsAnalyzedProperty.SUPPORTS_TLS13_PSK_EXCHANGE_MODES, TestResult.TRUE));
        checks.add(new ExtensionGuidelineCheck(
        ...
        checks.add(new ExtensionGuidelineCheck("Servers that support TLS 1.3 may support the cookie extension",
            RequirementLevel.MAY, new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_3, TestResult.TRUE),
        ...
        checks.add(new AnalyzedPropertyGuidelineCheck(
            ...
            RequirementLevel.SHOULD,
            new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_SCTS_PRECERTIFICATE, TestResult.FALSE),
            TlsAnalyzedProperty.SUPPORTS_SCTS_HANDSHAKE, TestResult.TRUE));
        checks.add(new AnalyzedPropertyGuidelineCheck(
            "Servers should not process early data received in the ClientHello message.", RequirementLevel.SHOULD,
            new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS_1_3, TestResult.TRUE),
            TlsAnalyzedProperty.SUPPORTS_TLS13_0_RTT, TestResult.FALSE));
        checks.add(new AnalyzedPropertyGuidelineCheck(
            "If the server does allow 0-RTT data, then the server should use the single-use ticket mechanism.",
            RequirementLevel.SHOULD,
            new GuidelineCheckCondition(TlsAnalyzedProperty.SUPPORTS_TLS13_0_RTT, TestResult.TRUE),
            TlsAnalyzedProperty.SUPPORTS_TLS13_SESSION_TICKETS, TestResult.TRUE));
        checks.add(new AnalyzedPropertyGuidelineCheck(
