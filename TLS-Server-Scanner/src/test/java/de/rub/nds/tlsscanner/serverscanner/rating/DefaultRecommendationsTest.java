...
public class DefaultRecommendationsTest {
    ...
    public void createDefaultRatingInfluencers() {
        ...
        recommendations
                .add(new Recommendation(AnalyzedProperty.SUPPORTS_SSL_2, "SSL 2.0 support",
                        "Evaluates whether the SSL 2.0 protocol is supported", new PropertyResultRecommendation(
                                TestResult.TRUE, "SSL 2.0 is enabled", "Disable SSL 2.0", ""),
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_SSL_3, "SSL 3.0 support",
                "Evaluates whether the SSL 3.0 protocol is supported", new PropertyResultRecommendation(
                        TestResult.TRUE, "SSL 3.0 is enabled", "Disable SSL 3.0"),
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_0, "TLS 1.0 support",
                "Evaluates whether the TLS 1.0 protocol is supported", new PropertyResultRecommendation(
                        TestResult.TRUE, "TLS 1.0 is enabled", "Consider disabling TLS 1.0", ""),
                "https://www.ietf.org/rfc/rfc2246"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_1, "TLS 1.1 support",
                "Evaluates whether the TLS 1.1 protocol is supported", new PropertyResultRecommendation(
                        TestResult.TRUE, "TLS 1.1 is enabled", "Consider disabling TLS 1.1", ""),
                "https://www.ietf.org/rfc/rfc4346"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_2, "TLS 1.2 support",
                "Evaluates whether the TLS 1.2 protocol is supported", new PropertyResultRecommendation(
                        TestResult.FALSE, "TLS 1.2 is disabled", "Enable TLS 1.2"),
                "https://www.ietf.org/rfc/rfc5246.txt"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_3, "TLS 1.3 support",
                "Evaluates whether the TLS 1.3 protocol is supported", new PropertyResultRecommendation(
                        TestResult.FALSE, "TLS 1.3 is disabled", "Enable TLS 1.3"),
                "https://tools.ietf.org/html/rfc8446"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_3_DRAFT,
                "TLS 1.3 draft version support", "Evaluates whether a TLS 1.3 version draft is supported",
                new PropertyResultRecommendation(TestResult.TRUE, "TLS 1.3 draft version is enabled",
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_DTLS_1_0, "DTLS 1.0 support",
                "Evaluates whether the DTLS 1.0 protocol is supported", new PropertyResultRecommendation(
                        TestResult.TRUE, "DTLS 1.0 is enabled", "Disable DTLS 1.0, it is a UDP protocol"),
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_DTLS_1_2, "DTLS 1.2 support",
                "Evaluates whether the DTLS 1.2 protocol is supported", new PropertyResultRecommendation(
                        TestResult.TRUE, "DTLS 1.2 is enabled", "Disable DTLS 1.2, it is a UDP protocol"),
                "https://tools.ietf.org/html/rfc6347"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_DTLS_1_3, "DTLS 1.3 support",
                "Evaluates whether the DTLS 1.3 protocol is supported", new PropertyResultRecommendation(
                        TestResult.TRUE, "DTLS 1.3 is enabled", "Disable DTLS 1.3, it is a UDP protocol"), ""));

        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_NULL_CIPHERS, "Null cipher support",
                "Evaluates whether the TLS server supports null ciphers", new PropertyResultRecommendation(
                        TestResult.TRUE, "Null ciphers are supported", "Disable insecure null ciphers"), ""));
        recommendations
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_DES, "DES support",
                "Evaluates whether the TLS server supports DES ciphers", new PropertyResultRecommendation(
                        TestResult.TRUE, "DES ciphers are enabled", "Disable DES ciphers"), ""));
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_IDEA,
                        "IDEA cipher support",
                        ...
                        new PropertyResultRecommendation(TestResult.TRUE, "IDEA ciphers are enabled",
                                "Disable IDEA ciphers"), "https://tools.ietf.org/html/rfc5469"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_RC2, "RC2 cipher support",
                ...
                "RC2 is a 64 bit block cipher designed by Ron Rivest in 1987", new PropertyResultRecommendation(
                        TestResult.TRUE, "RC2 ciphers are enabled", "Disable RC2 ciphers"), ""));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_RC4, "RC4 cipher support",
                ...
                "RC4 is a stream cipher designed by Ron Rivest in 1987", new PropertyResultRecommendation(
                        TestResult.TRUE, "RC4 ciphers are enabled", "Disable RC4 ciphers"),
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_AEAD,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_AES, "AES cipher support",
                "Evaluates whether the TLS server supports AES cipher", new PropertyResultRecommendation(
                        TestResult.FALSE, "AES cipher suites are disabled", "Enable AES cipher suites"), ""));
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_ARIA, "ARIA cipher support",
                ...
                "ARIA is a 128 bit block cipher designed in 2003", "https://tools.ietf.org/html/rfc5794"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_CHACHA, "ChaCha cipher support",
                "Evaluates whether the TLS server supports ChaCha cipher", new PropertyResultRecommendation(
                        TestResult.FALSE, "ChaCha cipher is disabled", "Enable ChaCha cipher"),
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_DH,
        ...
        // post quantum
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_POST_QUANTUM,
                "Post quantum algorithms support", "Evaluates whether the TLS server supports post quantum algorithms",
                ""));
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_EXTENDED_MASTER_SECRET,
                ...
                new PropertyResultRecommendation(TestResult.FALSE, "Extended master secret extension is not supported",
                        "Enable support for the extended master secret"), "https://tools.ietf.org/html/rfc7627"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_ENCRYPT_THEN_MAC,
                ...
                new PropertyResultRecommendation(TestResult.FALSE, "Encrypt-then-MAC extension is not supported",
                        "Enable support for the Encrypt-then-MAC"), "https://tools.ietf.org/html/rfc7366"));
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_SESSION_IDS,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_SESSION_TICKET_ROTATION_HINT,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_SECURE_RENEGOTIATION_EXTENSION,
                ...
                new PropertyResultRecommendation(TestResult.FALSE, "Secure renegotiation extension is disabled",
                        "Consider to enable secure renegotiation extension."), "https://tools.ietf.org/html/rfc5746"));
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_CLIENT_SIDE_SECURE_RENEGOTIATION,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_CLIENT_SIDE_INSECURE_RENEGOTIATION,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_ONLY_PRIME_MODULI,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_COMMON_DH_PRIMES,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_ONLY_SAFEPRIME_MODULI,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_HSTS,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_HSTS_PRELOADING,
                "Support for HTTP Strict Transport Security (HSTS) preloading", "", new PropertyResultRecommendation(
                        TestResult.FALSE, "HSTS is disabled", "Enable HSTS"), ""));
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.SUPPORTS_HPKP_REPORTING,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.HAS_COMPRESSION_INTOLERANCE,
                "TLS compression intolerance", "Evaluates whether the TLS server is TLS compression intolerant",
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.HAS_BIG_CLIENT_HELLO_INTOLERANCE,
                "Big TLS ClientHello intolerance",
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.IGNORES_OFFERED_NAMED_GROUPS,
                "Ignoring offered named groups", "Evaluates whether the TLS server ignores offered named groups",
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.VULNERABLE_TO_BLEICHENBACHER,
                        "Vulnerable to a Bleichenbacher attack",
                        "Evaluates whether the TLS server is vulnerable to a Bleichenbacher attack",
                        new PropertyResultRecommendation(TestResult.TRUE,
                                "The TLS server is vulnerable to a Bleichenbacher attack",
                                "There is a critical vulnerability in your TLS implementation. Update your software or contact the developers."),
                        "https://robotattack.org/"));
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.VULNERABLE_TO_PADDING_ORACLE,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.VULNERABLE_TO_POODLE,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.VULNERABLE_TO_TLS_POODLE,
                        "Vulnerable to TLS POODLE",
                        "Evaluates whether the TLS server is vulnerable to TLS POODLE (Padding Oracle On Downgraded Legacy Encryption)",
                        new PropertyResultRecommendation(TestResult.TRUE,
                                "The TLS server is vulnerable to POODLE with TLS",
                                "There is a critical vulnerability in your TLS implementation. Update your software or contact the developers."),
                        ""));
        recommendations.add(new Recommendation(AnalyzedProperty.VULNERABLE_TO_SWEET_32, "Vulnerable to Sweet32",
                "Evaluates whether the TLS server is vulnerable to Sweet32", new PropertyResultRecommendation(
                        TestResult.TRUE, "The TLS server is vulnerable to Sweet32",
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.VULNERABLE_TO_TICKETBLEED,
                        "Vulnerable to Ticketbleed",
                        "Evaluates whether the TLS server is vulnerable to Ticketbleed",
                        new PropertyResultRecommendation(TestResult.TRUE,
                                "The TLS server is vulnerable to Ticketbleed",
                                "There is a critical vulnerability in your TLS implementation. Update your software or contact the developers."),
                        "https://filippo.io/ticketbleed"));
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.VULNERABLE_TO_EARLY_CCS,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.VULNERABLE_TO_CRIME, "Vulnerable to CRIME",
                "Evaluates whether the TLS server is vulnerable to CRIME", new PropertyResultRecommendation(
                        TestResult.TRUE, "The TLS server is vulnerable to CRIME", "Disable TLS compression"),
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.VULNERABLE_TO_LOGJAM,
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.VULNERABLE_TO_FREAK, "Vulnerable to FREAK",
                "Evaluates whether the TLS server is vulnerable to FREAK", new PropertyResultRecommendation(
                        TestResult.TRUE, "The TLS server is vulnerable to FREAK", "Disable export cipher suites."),
                "https://www.smacktls.com/smack.pdf"));
        recommendations.add(new Recommendation(AnalyzedProperty.VULNERABLE_TO_RENEGOTIATION_ATTACK,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.MISSES_MAC_APPDATA_CHECKS,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.MISSES_MAC_FINISHED_CHECKS,
                        "Misses Finished message MAC check",
                        "Evaluates whether the TLS server correctly validates the Finished message MAC",
                        new PropertyResultRecommendation(TestResult.TRUE,
                                "The TLS server does not verify the Finished message MAC",
                                "There is a critical vulnerability in your TLS implementation. Update your software or contact the developers."),
                        ""));
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.MISSES_VERIFY_DATA_CHECKS,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.MISSES_GCM_CHECKS,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.HAS_WEAK_RANDOMNESS,
        ...
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.REUSES_EC_PUBLICKEY,
                        ...
                        new PropertyResultRecommendation(TestResult.TRUE,
                                "The TLS server reuses ephemeral elliptic curve keys",
                                "Configure your server to always use fresh elliptic curve keys"), ""));
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.REUSES_DH_PUBLICKEY,
                        ...
                        new PropertyResultRecommendation(TestResult.TRUE,
                                "The TLS server reuses ephemeral Diffie-Hellman keys",
                                "Configure your server to always use fresh Diffie-Hellman keys"), ""));
        recommendations
                .add(new Recommendation(
                        AnalyzedProperty.REUSES_GCM_NONCES,
                        "Reuses GCM nonces",
        ...
        RatingIO.writeRecommendations(new Recommendations(recommendations), new File("src/main/resources/"
                + Recommendations.DEFAULT_RECOMMENDATIONS_FILE));
        RatingIO.writeRecommendations(new Recommendations(recommendations), new File(
                "src/main/resources/rating/recommendations_en.xml"));
