...
public class DefaultRecommendationsTest {
    ...
    public void createDefaultRatingInfluencers() {
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_SSL_2, "SSL 2.0 support",
            "Evaluates whether the SSL 2.0 protocol is supported", new PropertyResultRecommendation(TestResult.TRUE,
                "SSL 2.0 is enabled", "Disable SSL 2.0", ""),
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_SSL_3, "SSL 3.0 support",
            "Evaluates whether the SSL 3.0 protocol is supported", new PropertyResultRecommendation(TestResult.TRUE,
                "SSL 3.0 is enabled", "Disable SSL 3.0"), "https://tools.ietf.org/html/rfc6101",
            "https://www.openssl.org/~bodo/ssl-poodle.pdf"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_0, "TLS 1.0 support",
            "Evaluates whether the TLS 1.0 protocol is supported", new PropertyResultRecommendation(TestResult.TRUE,
                "TLS 1.0 is enabled", "Consider disabling TLS 1.0", ""), "https://www.ietf.org/rfc/rfc2246"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_1, "TLS 1.1 support",
            "Evaluates whether the TLS 1.1 protocol is supported", new PropertyResultRecommendation(TestResult.TRUE,
                "TLS 1.1 is enabled", "Consider disabling TLS 1.1", ""), "https://www.ietf.org/rfc/rfc4346"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_2, "TLS 1.2 support",
            "Evaluates whether the TLS 1.2 protocol is supported", new PropertyResultRecommendation(TestResult.FALSE,
                "TLS 1.2 is disabled", "Enable TLS 1.2"), "https://www.ietf.org/rfc/rfc5246.txt"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_3, "TLS 1.3 support",
            "Evaluates whether the TLS 1.3 protocol is supported", new PropertyResultRecommendation(TestResult.FALSE,
                "TLS 1.3 is disabled", "Enable TLS 1.3"), "https://tools.ietf.org/html/rfc8446"));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_TLS_1_3_DRAFT,
            ...
            new PropertyResultRecommendation(TestResult.TRUE, "TLS 1.3 draft version is enabled",
                "Update your server and enable the TLS 1.3 final version"), "https://tools.ietf.org/html/rfc8446"));
        recommendations
            .add(new Recommendation(AnalyzedProperty.SUPPORTS_DTLS_1_0, "DTLS 1.0 support",
        ...
        recommendations
            .add(new Recommendation(AnalyzedProperty.SUPPORTS_DTLS_1_2, "DTLS 1.2 support",
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_DES, "DES support",
            "Evaluates whether the TLS server supports DES ciphers", new PropertyResultRecommendation(TestResult.TRUE,
                "DES ciphers are enabled", "Disable DES ciphers"), ""));
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_3DES, "3DES (Triple DES) support",
            "Evaluates whether the TLS server supports 3DES (Triple DES) ciphers", new PropertyResultRecommendation(
                TestResult.TRUE, "3DES ciphers are enabled", "Disable 3DES ciphers"), ""));
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_RC4, "RC4 cipher support",
            ...
            "RC4 is a stream cipher designed by Ron Rivest in 1987", new PropertyResultRecommendation(TestResult.TRUE,
                "RC4 ciphers are enabled", "Disable RC4 ciphers"), "https://tools.ietf.org/html/rfc7465",
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_ENCRYPT_THEN_MAC,
            ...
            "Evaluates whether the TLS server supports Encrypt-then-MAC extension", new PropertyResultRecommendation(
                TestResult.FALSE, "Encrypt-then-MAC extension is not supported",
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.SUPPORTS_CLIENT_SIDE_INSECURE_RENEGOTIATION,
            ...
            new PropertyResultRecommendation(TestResult.TRUE, "Insecure renegotiation is enabled",
                "Disable renegotiation or enable only secure renegotiation."), "https://tools.ietf.org/html/rfc5746"));
        ...
        recommendations.add(new Recommendation(AnalyzedProperty.HAS_BIG_CLIENT_HELLO_INTOLERANCE,
            "Big TLS ClientHello intolerance", "Evaluates whether the TLS server has big TLS ClientHello intolerance",
