...
/**
 * TestSet should check if DhValueAfterProbe detects insecure DH-Parameters as insecure ones and
 * secure parameters as secure ones
 */
public class DhValueAfterProbeTest {
    ...
    public void setup() {
        ...
        pubkeyContainer =
                new ExtractedValueContainer<CustomDhPublicKey>(TrackableValueType.DHE_PUBLICKEY);
