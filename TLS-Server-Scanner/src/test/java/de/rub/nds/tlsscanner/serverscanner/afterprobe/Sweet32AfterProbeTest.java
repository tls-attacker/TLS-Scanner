...
public class Sweet32AfterProbeTest {
	...
	/**
	 * Test if probe recognizes use of cipher suites using a 64 bit block size
	 * cipher.
	 */
	@Test
	...
	/**
	 * Test if probe correctly identifies cipher suites not using 64 bit blocksize
	 * ciphers as safe
	 */
	@Test
	...
	/**
	 * Test if probe recognizes ServerReport without any ciphers as invulnerable to
	 * Sweet32.
	 */
//    @Test
...
//    }
	...
	/**
	 * Test if vulnerability to Sweet32 is uncertain when the ServerReport is empty
